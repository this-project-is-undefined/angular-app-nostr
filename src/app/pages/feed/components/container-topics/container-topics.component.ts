...
@Component({
  selector: 'app-container-topics',
  standalone: true,
  imports: [MatCardModule, JsonPipe, AsyncPipe],
  templateUrl: './container-topics.component.html',
  styleUrls: ['./container-topics.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default,
})
export class ContainerTopicsComponent implements OnInit {
